...
| RSK-006 | Execution-authority misuse or scope overrun after readiness authority definition (`OQ-016`) | HIGH | CONFIRMED | Enforce `docs/09-delivery/foundation-slice-a-go-decision-2026-09-05.md` decision controls on every future GO/CONDITIONAL_GO: exact `WP-AZ-*` scope, non-waivable conditions, auditable evidence links, and residual-risk record; pause execution on any critical contradiction | Project Owner + Programme Governance |
