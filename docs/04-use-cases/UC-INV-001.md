# UC-INV-001 — Submit an investment commitment

## 1. Objective
Record an intention or binding commitment to invest
...
## 7. Trigger
- Actor initiates Submit an investment commitment.
...
## 18. Dependencies
- Opportunity open, DD where required, eligibility
