# UC-DOC-001 — View and download reports and tax documents

## 1. Objective
Obtain authorised portfolio and tax documentation
...
## 7. Trigger
- Actor initiates View and download reports and tax documents.
