# UC-ADMIN-002 — Update, close, pause, or archive an opportunity

## 1. Objective
Maintain opportunity lifecycle accurately
...
## 7. Trigger
- Actor initiates Update, close, pause, or archive an opportunity.
