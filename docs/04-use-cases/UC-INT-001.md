# UC-INT-001 — Exchange identity or KYC/AML data with an external provider

## 1. Objective
Verify investor status reliably
...
## 7. Trigger
- Actor initiates Exchange identity or KYC/AML data with an external provider.
