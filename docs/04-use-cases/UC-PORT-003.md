# UC-PORT-003 — View portfolio performance

## 1. Objective
Understand portfolio value and performance
...
## 7. Trigger
- Actor initiates View portfolio performance.
...
## 18. Dependencies
- Holdings, valuations, cash flows
