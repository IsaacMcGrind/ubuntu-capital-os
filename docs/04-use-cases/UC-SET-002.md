# UC-SET-002 — Record and reconcile investor funds

## 1. Objective
Match funds to the correct commitment
...
## 7. Trigger
- Actor initiates Record and reconcile investor funds.
...
## 18. Dependencies
- Funding receipt, reference data
