# UC-AUD-002 — Investigate a compliance or security event

## 1. Objective
Determine facts, impact, and remediation
...
## 7. Trigger
- Actor initiates Investigate a compliance or security event.
