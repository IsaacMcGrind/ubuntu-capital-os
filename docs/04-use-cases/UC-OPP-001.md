# UC-OPP-001 — Browse visible investment opportunity cards and categories

## 1. Objective
Discover available opportunity summaries shown by the reference interface
...
## 7. Trigger
- Actor initiates Browse visible investment opportunity cards and categories.
