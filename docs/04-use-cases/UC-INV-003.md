# UC-INV-003 — Cancel or withdraw an investment request

## 1. Objective
Stop an eligible pending commitment
...
## 7. Trigger
- Actor initiates Cancel or withdraw an investment request.
...
## 18. Dependencies
- Pending commitment, cancellation policy
