# UC-ADMIN-004 — Manage platform content and reference data

## 1. Objective
Keep categories, sectors, themes, locations, events, and content current
...
## 7. Trigger
- Actor initiates Manage platform content and reference data.
