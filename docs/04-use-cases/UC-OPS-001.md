# UC-OPS-001 — Respond to an investor support request

## 1. Objective
Resolve an investor question or incident
...
## 7. Trigger
- Actor initiates Respond to an investor support request.
...
## 18. Dependencies
- Support channel, access controls
