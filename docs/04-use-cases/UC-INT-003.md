# UC-INT-003 — Deliver email or in-app communications

## 1. Objective
Notify actors and preserve delivery evidence
...
## 7. Trigger
- Actor initiates Deliver email or in-app communications.
