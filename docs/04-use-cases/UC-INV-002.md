# UC-INV-002 — Review and resolve a pending investment

## 1. Objective
Reach an accepted, rejected, cancelled, or remediated status
...
## 7. Trigger
- Actor initiates Review and resolve a pending investment.
