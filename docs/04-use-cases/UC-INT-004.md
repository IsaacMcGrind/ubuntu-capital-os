# UC-INT-004 — Exchange settlement data with banking or payment services

## 1. Objective
Support funding and reconciliation
...
## 7. Trigger
- Actor initiates Exchange settlement data with banking or payment services.
