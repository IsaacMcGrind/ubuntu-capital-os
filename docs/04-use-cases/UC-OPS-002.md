# UC-OPS-002 — Correct investor or investment data under control

## 1. Objective
Resolve verified data defects without compromising auditability
...
## 7. Trigger
- Actor initiates Correct investor or investment data under control.
