# UC-DD-001 — Initiate an NDA action for an opportunity

## 1. Objective
Begin the process required to access restricted opportunity content
...
## 7. Trigger
- Actor initiates Initiate an NDA action for an opportunity.
...
## 18. Dependencies
- Opportunity, identity, agreement service
