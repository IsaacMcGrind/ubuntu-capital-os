# UC-ADMIN-001 — Create and publish an investment opportunity

## 1. Objective
Make a reviewed opportunity discoverable to eligible investors
...
## 7. Trigger
- Actor initiates Create and publish an investment opportunity.
...
## 18. Dependencies
- Permissions, content, compliance approval
