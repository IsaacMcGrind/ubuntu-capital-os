...
## 1. Objective
Establish KYC/AML and accreditation status
...
## 4. Primary Actor
- Compliance actor / external service
...
## 7. Trigger
- Actor initiates Verify investor identity and compliance status.
...
## 18. Dependencies
- Profile submission, integrations
