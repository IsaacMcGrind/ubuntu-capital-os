# UC-PUB-001 — Learn about the investment platform

## 1. Objective
Understand the proposition and decide whether to register
...
## 7. Trigger
- Actor initiates Learn about the investment platform.
