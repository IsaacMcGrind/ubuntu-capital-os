...
Corefinity PRs use capacity `CONTRACTOR_TECHNICAL_EVIDENCE`, remain within an explicitly assigned work package and authorised paths, and complete `.github/pull_request_template.md`. Architecture-analysis provenance may support an 80K Developers Project Manager decision but does not become that decision.
